...
| `#[derive(...)]` (built-in derives) | §9.13 | §9.6, §9.7 | M1 | Compiler-implemented; no user derives. |
| Attributes (records + traits + manifest) | §9.13 | §9.7 | M1 | No bespoke construct, no comptime. |
