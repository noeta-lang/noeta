...
```toml ignore
noeta-ext-abi = { git = "https://github.com/noeta-lang/noeta", tag = "v0.8.2" }
```
...
[dev-dependencies]
noeta-conformance = { git = "https://github.com/noeta-lang/noeta", tag = "v0.8.2" }
noeta-stdlib      = { git = "https://github.com/noeta-lang/noeta", tag = "v0.8.2" }
```
