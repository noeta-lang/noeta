...
pub use registry::{
    ...
    EnumBacking, ExtBundle, ExtCapability, ExtEnum, ExtFn, ExtModule, ExtTrait, ExtTraitMethod,
    ExtType, ExtVariant, Extension, HiddenArg, ModuleDispatch, NativeOut, NativeValue,
