...
pub(crate) fn marshal_native_arg(value: Value) -> lang_stdlib::NativeValue {
...
pub(crate) fn value_to_scalar(value: Value) -> Option<lang_stdlib::Scalar> {
...
pub(crate) fn scalar_to_value(scalar: lang_stdlib::Scalar) -> Value {
    use lang_stdlib::Scalar;
    match scalar {
...
/// Lift a native-extension [`lang_stdlib::NativeOut`] result back into a VM value, supplying the
...
pub(crate) fn materialize_ext(
    out: lang_stdlib::NativeOut,
    ret: lang_stdlib::RetTy,
    args: &[Value],
) -> Value {
...
pub(crate) fn materialize_native(out: lang_stdlib::NativeOut) -> Value {
...
pub(crate) fn stdlib_output_to_value(output: lang_stdlib::Output) -> Value {
    match output {
...
pub(crate) fn stdlib_error_code(kind: lang_stdlib::ErrorKind) -> DiagnosticCode {
    match kind {
...
pub(crate) fn set_tag_from_list(list: Value) -> Option<Rc<lang_ast::reflect::TypeRepr>> {
...
pub(crate) fn vm_type_repr(value: &Value) -> lang_ast::reflect::TypeRepr {
    use lang_ast::reflect::TypeRepr;
    let v = *value;
...
pub(crate) fn build_type_value(repr: &lang_ast::reflect::TypeRepr) -> Value {
...
pub(crate) fn materialize_recipe(out: lang_stdlib::NativeOut) -> Value {
    use lang_stdlib::{NativeOut, Scalar};
    match out {
        NativeOut::Scalar(Scalar::Int(n)) => Value::int(n),
        NativeOut::Scalar(Scalar::Float(f)) => Value::float(f),
