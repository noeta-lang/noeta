...
fn run_workspace(raw: &lang_loader::RawWorkspace, report: &mut IrCorpusReport) {
    let db = LangDatabase::default();
...
fn run(program: &lang_ast::Program, checked: &lang_db::Checked, report: &mut IrCorpusReport) {
