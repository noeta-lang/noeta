...
fn render_syntax_md() -> String {
    ...
    out.push_str(&format!(
        "# The Noeta language reference\n\n\
         Generated by `noeta init` (noeta {}) from the toolchain's embedded language\n\
         guide — the same pages `noeta mcp`'s `docs_search` serves. It matches the\n\
         installed compiler; after upgrading the toolchain, delete this file and re-run\n\
         `noeta init` to refresh it.\n\n## Contents\n\n",
