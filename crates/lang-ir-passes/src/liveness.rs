...
//!
//! Only **source variables** ([`lang_ir::Atom::Var`]) are tracked. ANF temporaries are single-use
...
use lang_ir::{Atom, Block, Decl, ForPattern, Func, Pattern, Program, Rvalue, Stmt};
