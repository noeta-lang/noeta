...
Status: **in-progress** (S0–S3c done, incl. list-building L1–L3; **S4 done** — bounded generics, E0025; **S5 done** — trait coherence, E0027; **S6 done** — `dyn` narrowing `x.as<T>()`, E0028; **S8 done** — declared union types `A | B`; S7 finalize next)
...
| S7 | Migration finalize + cleanup | todo (closing slice) |
