...
Status: in progress (M1.9.1 done — multi-file loader + linker + real `use` resolution, both backends; M1.9.2 partly done — `pub` visibility + E0019 import errors + E0013 unknown-type landed, SourceMap/cross-module-checking todo; M1.9.3 salsa module graph todo)
