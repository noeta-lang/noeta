...
| 10 | [Layered stdlib (Ring 1 + Ring 2)](m1/slice-10-stdlib.md) | C | in progress (M1.10.1 string surface + M1.10.2 list/map methods done — `lang-stdlib` shared so the differential holds by construction; list sorted/slice/first/last + Ring 2 remain) |
