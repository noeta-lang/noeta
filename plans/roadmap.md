...
| 10 | [Layered stdlib (Ring 1 + Ring 2)](m1/slice-10-stdlib.md) | C | in progress (M1.10.1 done — `lang-stdlib` + Ring 1 string surface shared by both backends so the differential holds by construction; list/map/set + Ring 2 remain) |
