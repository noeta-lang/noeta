...
| Channel FIFO + bounded-capacity rules | both backends | Policy is neutral; buffers are per-repr | KEEP for now (small, stable, differential-pinned by the isolate corpus) |
