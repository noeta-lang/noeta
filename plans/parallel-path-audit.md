...
**Closed:** row 1 (one run tail), row 3 (provenance is one value), row 7 (one jump-target answer), row 12 (both artifact halves gated). **In flight:** rows 5, 6, 9, 11, 13. **Open:** rows 2, 4, 8, 10, 14.
