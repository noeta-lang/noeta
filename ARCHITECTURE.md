...
| `noeta-crdt` | Local-first CRDTs (gcounter/pncounter/gset) consumed by the `para.crdt`/`para.synced` modules; the p2panda transport lives in `noeta-para-p2p-net` (the `para.p2p` extension). |
